...
<div class="wp-block-group">
	...
	<div class="wp-block-columns are-vertically-aligned-bottom is-not-stacked-on-mobile">
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:100%">
			...
			<div class="wp-block-group has-sm-font-size">
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Item #1', 'uabdragon' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( '100%', 'uabdragon' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
			<div class="wp-block-group has-uab-green-background-color has-background">
	...
	<div class="wp-block-columns are-vertically-aligned-bottom is-not-stacked-on-mobile">
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:90%">
			...
			<div class="wp-block-group has-sm-font-size">
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Item #2', 'uabdragon' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( '90%', 'uabdragon' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:10%">
			...
			<div class="wp-block-group has-grey-background-color has-background">
				<!-- wp:spacer {"height":"20px"} -->
				<div style="height:20px" aria-hidden="true" class="wp-block-spacer"></div>
				<!-- /wp:spacer -->
			</div>
	...
	<div class="wp-block-columns are-vertically-aligned-bottom is-not-stacked-on-mobile">
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:80%">
			...
			<div class="wp-block-group has-sm-font-size">
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Item #3', 'uabdragon' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( '80%', 'uabdragon' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
	...
	<div class="wp-block-columns are-vertically-aligned-bottom is-not-stacked-on-mobile">
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:70%">
			...
			<div class="wp-block-group has-sm-font-size">
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Item #4', 'uabdragon' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( '70%', 'uabdragon' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
	...
	<div class="wp-block-columns are-vertically-aligned-bottom is-not-stacked-on-mobile">
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:60%">
			...
			<div class="wp-block-group has-sm-font-size">
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Item #5', 'uabdragon' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( '60%', 'uabdragon' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
	...
	<div class="wp-block-columns are-vertically-aligned-bottom is-not-stacked-on-mobile">
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:50%">
			...
			<div class="wp-block-group has-sm-font-size">
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Item #6', 'uabdragon' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( '50%', 'uabdragon' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
