 ...
 * Slug: uabdragon/footer-stacked
 * Categories: uabdragon-footer
 * Block Types: core/template-part/footer
 */
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|xl","bottom":"var:preset|spacing|sm","right":"30px","left":"30px"},"margin":{"top":"0px"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull" style="margin-top:0px;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--small);padding-left:30px">
	...
	<p class="has-text-align-center has-sm-font-size">&copy; 2023 <?php echo esc_html__( 'Your Company LLC', 'uabdragon' ); ?> · <a href="#"><?php echo esc_html__( 'Contact Us', 'uabdragon' ); ?></a></p>
	<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
