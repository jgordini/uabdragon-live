 ...
 * Slug: uabdragon/comments
 * Inserter: no
 */
?>
<!-- wp:group {"tagName":"section","style":{"spacing":{"margin":{"top":"var:preset|spacing|md"}}},"className":"entry-comments","layout":{"type":"constrained"}} -->
<section class="wp-block-group entry-comments" style="margin-top:var(--wp--preset--spacing--medium)">
	<!-- wp:comments {"className":"wp-block-comments-query-loop"} -->
	<div class="wp-block-comments wp-block-comments-query-loop">
		<!-- wp:heading --><h2><?php echo esc_html__( 'Comments', 'uabdragon' ); ?></h2><!-- /wp:heading -->
		...
		<div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--medium)">
			<!-- wp:comment-template -->
			<!-- wp:group {"tagName":"article","style":{"spacing":{"blockGap":"var:preset|spacing|xs","margin":{"bottom":"var:preset|spacing|sm"}}},"layout":{"type":"default"}} -->
